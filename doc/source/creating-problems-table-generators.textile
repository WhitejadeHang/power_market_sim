...
|fast start| unit has the ability to start up without having been committed if needed to avoid load shedding (when simpower is run using the faststart option)| False | |
