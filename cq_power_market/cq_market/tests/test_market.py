...
from cq_market.bid_validator import BidValidator
from cq_market.agents import BiddingAgent, PriceTakerAgent
from cq_market.ieee_network import (
    create_ieee6bus, generate_load_profile_96, generate_wind_profile_96,
)
from cq_market.pypsa_clearing import (
    PyPSAMarketClearing, decompose_bid_to_segments,
)
from cq_market.settlement import SettlementEngine
...
class TestIntegration:
    def test_demo_runs_highs(self):
        from cq_market.demo import create_units, create_bids, build_market_network_and_run
