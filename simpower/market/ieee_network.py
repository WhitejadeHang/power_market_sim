...
def create_ieee6bus(snapshots: pd.DatetimeIndex | None = None) -> pypsa.Network:
    ...
    lines_data = [
        ("Bus1", "Bus2", 0.10, 0.20, 500),
        ("Bus1", "Bus4", 0.05, 0.20, 250),   # 关键断面: Bus1→Bus4
        ("Bus1", "Bus5", 0.08, 0.30, 200),   # 关键断面: Bus1→Bus5
        ("Bus2", "Bus3", 0.05, 0.25, 400),
        ("Bus2", "Bus4", 0.05, 0.10, 300),
        ("Bus2", "Bus5", 0.10, 0.30, 200),   # 较窄
        ("Bus2", "Bus6", 0.07, 0.20, 400),
        ("Bus3", "Bus5", 0.12, 0.26, 150),   # 较窄
        ("Bus3", "Bus6", 0.02, 0.10, 400),
        ("Bus4", "Bus5", 0.20, 0.40, 150),   # 较窄
        ("Bus5", "Bus6", 0.10, 0.30, 200),
    ]
    base_mva = 100
    v_nom = 230
